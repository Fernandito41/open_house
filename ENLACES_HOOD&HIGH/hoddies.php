...
<main class="imagenes"><!--imagenes de apartado de hombre,mujer y verano-->
  ...
  <div class="texto_imagen">
    ...
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddiebasic.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie.png" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie basic</p> <!--El nomnbre de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddieaime.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie2.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie Aime</p> <!--El nomnbre de la prenda-->
            <p class="precio">$49.99</p><!--El precio de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddieblack.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie3.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie Black</p> <!--El nomnbre de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/sweatshirtgray.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie4.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Sweatshirt gray</p> <!--El nomnbre de la prenda-->
            <p class="precio">$30.99</p><!--El precio de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddieessentials.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddies5.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie Essentials</p> <!--El nomnbre de la prenda-->
            <p class="precio">$35.99</p><!--El precio de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddiebasicblack.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie6.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie basic black</p> <!--El nomnbre de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddiebasicgrey.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie7.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie basic gray</p> <!--El nomnbre de la prenda-->
            <p class="precio">$49.99</p><!--El precio de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddiestreatwear.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie10.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie Streatwear</p> <!--El nomnbre de la prenda-->
    ...
    <div class="Cajas"><!--Se abre la caja donde se vera la imagen y el nombre de la prenda-->
    <div class="cotenido">
      <a href="../catalogo hombre/hoodies/hoddiegapblue.php"><!--Se abre un link que te envia a otro lugar de la pagina donde aparece solamente la prenda y su in
            formacion-->
        <img src="../img/hoddie11.jpg" alt=""><!--Imagen de la prenda-->
      </a><!--Se cierra el link-->
    <div class="informacion"><!--Se abre el div de la informacion de la prenda-->
            <p class="nombre">Hoodie GAP Blue</p> <!--El nomnbre de la prenda-->
            <p class="precio">$40.99</p><!--El precio de la prenda-->
