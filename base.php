...
<body>
    ...
    <button class="registro"><i class="fa-regular fa-user"></i></button>
</a>
    ...
    <!-- IMAGENES DEL PRIMER APARTADO -->
    <main class="imagenes"><!--clase para estilo de imagenes-->
        <div class="texto_imagen">
         
            <a href="./ENLACES_HOOD&HIGH/hombre.php"><img src="img/hombre.jpg" alt="Hombre"><div class="texto">Hombre</div></a>
        </div>
        <div class="texto_imagen">
            <a href="./ENLACES_HOOD&HIGH/mujer.php"><img src="img/mujer.jpg" alt="Mujer"><div class="texto">Mujer</div></a>
        </div>
        <div class="texto_imagen">
            <a href="./ENLACES_HOOD&HIGH/verano.php"><img src="img/verano.jpg" alt="Verano"><div class="texto">Verano</div></a>
        </div><!--termina los apartados de las imagenes-->
    </main>
   ...
   <footer class="footer">
          ...
          <a href="https://www.facebook.com/share/17Up44UBYq/?mibextid=wwXIfr" class="icon facebook">
      <div class="tooltip">Facebook</div>
      <span><i class="fab fa-facebook-f"></i></span><!--Icono de facebook-->
    </a>
    <a href="https://x.com/hoodandhig" class="icon twitter">
