...
<div class="container">
    ...
    <p class="color">Amarillo</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        <b>COLOR:</b> AMARILLO<br>
        ...
        <b>DESCRIPCION: Una camisa de manga corta en color claro, con un cuello tipo Henley y un diseño simple y versátil.
    ...
    <input type="hidden" name="nombre_producto" value="Blusa elegante">
