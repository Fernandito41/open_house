...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos8.jpg" alt="Camisa con boton delantero">
    <img src="../img/veranos8.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa con boton delantero</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa con boton delantero">
