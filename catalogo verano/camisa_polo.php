...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos12.jpg" alt="Camisa Polo">
    <img src="../img/veranos12.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION: Playera de manga corta de color azul oscuro con cuello tipo polo.
    ...
    <input type="hidden" name="nombre_producto" value="Camisa Polo">
