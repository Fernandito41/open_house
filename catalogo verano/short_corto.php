...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos6.jpg" alt="Short corto">
    <img src="../img/veranos6.jpg">
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
       ...
       <b>DESCRIPCION:  Un short de color blanco con un diseño de cintura elástica y un cordón ajustable, perfecto para el verano.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short corto">
