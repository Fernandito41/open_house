...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/Veranoss.jpg" alt="Blusa otoño">
    <img src="../img/Veranoss.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:   Un body de color blanco con un diseño de escote en V pronunciado y una textura de punto acanalado.
  ...
  <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Boddie blanco">
