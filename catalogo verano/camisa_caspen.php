...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos3.jpg" alt="Camisa caspen">
    <img src="../img/veranos3.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION: Una camisa de manga corta con rayas verticales en tonos claros, que ofrece un estilo clásico y fresco.
    ...
    <input type="hidden" name="nombre_producto" value="Camisa caspen">
