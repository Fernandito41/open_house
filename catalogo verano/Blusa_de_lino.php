...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos1.jpg" alt="Blusa de lino">
    <img src="../img/veranos1.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Una blusa de lino de manga larga en color oscuro, con un corte recto y cuello clásico.
    ...
    <input type="hidden" name="nombre_producto" value="Blusa de lino">
