...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos2.jpg" alt="Blusa de lino">
    <img src="../img/veranos2.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Blusa de manga corta</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Una blusa de manga corta en color claro, con un diseño de cuello abierto y un estilo casual.
    ...
    <input type="hidden" name="nombre_producto" value="Blusa de manga corta">
