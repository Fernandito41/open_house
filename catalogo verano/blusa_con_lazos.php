...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/verano3.jpg" alt="Camisa boxy fit">
    <img src="../img/verano3.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Blusa con lazos</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION: Una camisa de manga corta en color oscuro, con un corte sencillo y bolsillos frontales.
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Blusa con lazos">
