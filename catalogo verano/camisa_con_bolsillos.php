...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/verano1.jpg" alt="Camisa con bolsilos">
    <img src="../img/verano1.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa con bolsillos</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa con bolsillos">
