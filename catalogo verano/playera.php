...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos9.jpg" alt="Playera marrón">
    <img src="../img/veranos9.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Playera marrón</h2>
    <p class="price">$15.00</p>
    <p class="color">Marrón</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Playera sin mangas de color marrón oscuro.
    ...
    <input type="hidden" name="nombre_producto" value="Playera marrón">
