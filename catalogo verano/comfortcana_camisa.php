...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos10.jpg" alt="Camisa Comfortcana">
    <img src="../img/veranos10.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa Comfortcana</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Camisa de manga corta de color blanco, con botones y un bolsillo en el pecho.
    ...
    <input type="hidden" name="nombre_producto" value="Camisa Comfortcana">
