...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos11.jpg" alt="Playera blanca">
    <img src="../img/veranos11.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Playera blanca</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Playera sin mangas de color blanco, con un corte sencillo.
    ...
    <input type="hidden" name="nombre_producto" value="Playera blanca">
