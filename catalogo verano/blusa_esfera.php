...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos13.jpg" alt="Blusa esfera">
    <img src="../img/veranos13.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:   Camisa de manga corta de color beige claro con cuello y botones.
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Blusa esfera">
