...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/veranos14.jpg" alt="Short de playa">
    <img src="../img/veranos14.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short de playa</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Short de playa corto de color azul oscuro.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short de playa">
