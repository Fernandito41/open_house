...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../img/verano4.jpg" alt="Camisa floreada">
    <img src="../img/verano4.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa floreada</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION: Una camisa de manga corta con un estampado floral en blanco y negro, ideal para un look veraniego.
    ...
    <input type="hidden" name="nombre_producto" value="Camisa floreada">
