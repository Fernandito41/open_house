...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt8.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt8.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa basic grey</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Gris claro con suavidad visual, con un logo discreto pero con intencion. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa basic grey">
