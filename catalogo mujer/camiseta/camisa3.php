...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/top10.jpg" alt="Camisa boxy fit">
    <img src="../../img/top10.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize Dominican</h2>
    <p class="price">$40.00</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        <b>COLOR:</b> BLANCA CON CAFE<br>
        ...
        <b>DESCRIPCION:Cafe con sombra estilo contenido, este tono neutro tiene profundidad ideal para looks urbanos. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize Dominican">
