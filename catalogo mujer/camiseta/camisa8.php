...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt4.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt4.png">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Corte alto y actitud directa, crop top con diseño frontal que poyecta seguridad. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa Crop">
