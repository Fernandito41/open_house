...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt3.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt3.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize X Dragons</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Blanco con un logo frontal, camisa basica que no necesita adornos el blanco puro y el diseño centrado lo convierten en una pieza versatil. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize X Dragons">
