...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize blue X HALLONE</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Azul oscuro con peso visual, el tono profundo y el tejido grueso l dan presencia. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize blue X HALLONE">
