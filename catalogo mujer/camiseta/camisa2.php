...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/top8.jpg" alt="Camisa boxy fit">
    <img src="../../img/top8.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize X NFL</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Blanco desgastado con actitud suave suave, esta camiseta lo lleva con textura, con historia. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize X NFL">
