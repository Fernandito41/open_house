...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt6.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt6.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Crop basic white</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Blanco total sin ruido, un crop basico para construir cualquier outfit urbano. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Crop basic white">
