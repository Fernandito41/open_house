...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt7.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt7.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa basic green</h2>
    <p class="price">$27.00</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        <b>COLOR:</b>VERDE MUSGO<br>
        ...
        <b>DESCRIPCION:Verde musgo con corte ajustado, esta camiseta se adapta al cuerpo con naturalidad.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa basic green">
