...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt2.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt2.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize Dominican Blue</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Azul profundo con una vibra estructurada, esta camisa lleva el peso del minimalismo urbano. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize Dominican Blue">
