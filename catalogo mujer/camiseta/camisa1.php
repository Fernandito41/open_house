...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/top7.jpg" alt="Camisa boxy fit">
    <img src="../../img/top7.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa oversize Brooklyn</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Blanca total con vibra nostalgica, esta camisa tiene un tono lavado que evoca tardes largas y calles vividas.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize Brooklyn">
