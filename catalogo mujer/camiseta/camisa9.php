...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt5.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt5.png">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa Manga Larga Crop

</h2>
    <p class="price">$42.00</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        <b>COLOR:</b> AZUL CON BLANCO<br>
        ...
        <b>DESCRIPCION:Negro con contraste grafico, camisa manga larga crop con diseño al frente que impone para quienes prefieren el statement directo y sin filtros. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa Manga Larga Crop">
    ...
    <div class="sizes">
        <label><input type="radio" name="talla" value="14" required> 14</label>
