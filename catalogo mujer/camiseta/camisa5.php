...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/tshirt1.png" alt="Camisa boxy fit">
    <img src="../../img/tshirt1.png">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Crop top con lineas horizontales que dan caracter fuerte, las lineas le da a esta pieza una vibra rebelde. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Crop Top">
