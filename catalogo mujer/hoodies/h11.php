...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera12.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera12.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera X PRECISE</h2>
    <p class="price">$40.00</p>
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        <b>COLOR:</b> GRIS<br>
        ...
        <b>DESCRIPCION:Comodidad con flow y actitud. La Sudadera X PRECISE destaca por su diseño oversize y tono gris claro, ideal para un outfit relajado pero con presencia. Perfecta para quienes viven el estilo urbano con confianza y autenticidad.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera X PRECISE">
