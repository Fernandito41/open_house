...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera1.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Basic Gray</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Versatil y comoda, esta sudadera gris basica es perfecta para crear un look relajado sin perder el toque street. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Basic Gray">
