...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera11.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera11.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Basic</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Minimal pero con presencia. Su diseño limpio y color claro la hacen una pieza esencial en el armario urbano. Perfecta para un estilo moderno, cómodo y sin complicaciones.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Basic">
