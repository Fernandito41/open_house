...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera8.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera8.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudaera Crop con Capucha</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Moderna y atrevida. Su corte corto y estilo deportivo te dan un look casual con un toque rebelde. Perfecta para destacar con un outfit relajado y lleno de flow.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudaera Crop con Capucha">
