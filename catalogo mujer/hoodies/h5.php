...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera5.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera5.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Boston</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Clásica, cómoda y con vibra college. Su estilo universitario y tonos contrastantes la hacen ideal para quienes buscan un look casual con esencia retro.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Boston">
