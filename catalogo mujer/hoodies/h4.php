...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera4.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera4.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Inspiración deportiva con esencia urbana. Su diseño tipo jersey y detalles en la espalda te dan ese aire de cancha y calle al mismo tiempo.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera NFL">
