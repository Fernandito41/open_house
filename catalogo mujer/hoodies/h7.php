...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera7.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera7.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Black</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Sencilla, versátil y lista para cualquier plan. Su diseño minimalista en negro puro encaja con todo, manteniendo ese aire urbano y relajado que nunca pasa de moda.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Black">
