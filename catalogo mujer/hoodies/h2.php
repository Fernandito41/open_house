...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera2.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera2.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Culture Blue</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:El estilo oversize que marca tendencia, su tono azul intenso y diseño urbano la hacen perfecta para quienes aman destacar con flow.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Culture Blue">
