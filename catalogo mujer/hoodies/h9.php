...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera10.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera10.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Basic Gray con Capucha</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:La clásica que nunca falla. Cómoda, suave y con un tono gris que combina con todo. Ideal para los días chill o para un look effortless con vibra de ciudad.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Basic Gray con Capucha">
