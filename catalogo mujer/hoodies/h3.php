...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/sudadera3.jpg" alt="Camisa boxy fit">
    <img src="../../img/sudadera3.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sudadera Crop White</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Fresca y con actitud, su corte crop y color blanco la convierten en la pieza ideal para looks casuales pero con estilo.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Sudadera Crop White">
