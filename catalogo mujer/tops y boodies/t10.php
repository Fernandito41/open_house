...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss11.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss11.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Boddie Verde Oscuro</h2>
    <p class="price">$30.00</p>
    <p class="informacion"> <b>MANGA:</b>CORTA<br>
        <b>COLOR:</b> VERDE OSCURO<br>
        ...
        <b>DESCRIPCION:  Un boddie de tirantes finos de color verde oscuro, con un diseño de encaje en la parte delantera.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Boddie Verde Oscuro">
