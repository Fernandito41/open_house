...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss10.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss10.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b>CORTA<br>
        ...
        <b>DESCRIPCION:  Un boddie de tirantes finos de color verde claro, con un diseño de encaje en la parte delantera.
    ...
    <input type="hidden" name="nombre_producto" value="Boddie Verde">
