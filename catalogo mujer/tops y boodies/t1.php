...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss2.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss2.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION: Un top de manga larga de color azul oscuro, con un diseño que deja el abdomen al descubierto.
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Top Azul">
