...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss6.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss6.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b>CORTA<br>
        ...
        <b>DESCRIPCION:  Un boddie de tirantes finos de color blanco con un estampado de camuflaje en la parte inferior.
