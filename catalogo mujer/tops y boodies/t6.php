...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss7.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss7.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b>CORTA<br>
        ...
        <b>DESCRIPCION:  Un boddie de tirantes finos con estampado de rayas.
    ...
    <input type="hidden" name="nombre_producto" value="Boddie Rayado">
