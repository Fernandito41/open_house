...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss5.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss5.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b>LARGA<br>
        ...
        <b>DESCRIPCION:  Un boddie de manga larga asimétrico de color negro, con un hombro al descubierto.
    ...
    <input type="hidden" name="nombre_producto" value="Boddie Negro">
