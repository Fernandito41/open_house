...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss8.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss8.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b>CORTA<br>
        ...
        <b>DESCRIPCION: Un top de color negro con un diseño asimétrico en la parte superior, sin tirantes en un lado.
    ...
    <input type="hidden" name="nombre_producto" value="Top Asimetrico">
