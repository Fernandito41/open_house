...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/topss3.jpg" alt="Camisa boxy fit">
    <img src="../../img/topss3.jpg">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:  Un top de manga corta de rayas horizontales blancas y marrones, que deja el abdomen al descubierto.
    ...
    <input type="hidden" name="nombre_producto" value="Top Rayado">
