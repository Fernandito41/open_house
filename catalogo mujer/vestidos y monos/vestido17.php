...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido15.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido15.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono color blanco manga larga</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Jeans acampanados se caracterizan por ser ajustados en la cintura y los muslos.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Mono color blanco manga larga">
