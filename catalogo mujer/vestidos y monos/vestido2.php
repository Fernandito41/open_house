...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido3.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido3.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono color Negro</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Mono color Negro">
