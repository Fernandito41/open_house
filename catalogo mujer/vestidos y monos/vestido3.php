...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestidos2.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestidos2.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono color blanco</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Los monos blancos de mujer se pueden describir con una sola palabra: "versátiles".
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Mono color blanco">
