...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/mono1.jpg" alt="Camisa boxy fit">
    <img src="../../img/mono1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono color cafe</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Los monos cafes de mujer se pueden describir con una sola palabra: "versátiles".
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Mono color cafe">
