...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido14.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido14.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Flare jegs jeans color blanco</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Jeans acampanados se caracterizan por ser ajustados en la cintura y los muslos, y ensancharse gradualmente desde la rodilla hacia abajo.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Flare jegs jeans color blanco">
