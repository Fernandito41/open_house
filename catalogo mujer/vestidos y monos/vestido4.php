...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestidos1.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestidos1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono color negro grafitto</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Mono color negro grafitto">
