...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido9.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido9.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Flar Jegs jeans verde claro</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Flar Jegs jeans verde claro">
