...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido4,jpg.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido4,jpg.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Vestido verde corto</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Vestido corto se caracteriza por su longitud que termina en o por encima de la mitad del muslo, o justo por encima de la rodilla.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Vestido verde corto">
