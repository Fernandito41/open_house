...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido6.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido6.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Vestido celeste mediano</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Vestido mediano para mujer se caracteriza por su largo entre la rodilla y el tobillo. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Vestido celeste mediano">
