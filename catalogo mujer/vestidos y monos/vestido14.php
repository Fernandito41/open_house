...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido12.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido12.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Mono verde oscuro</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Mono verde oscuro">
