...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido8.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido8.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Flar Jegs jeans verde oscuro</h2>
    ...
    <input type="hidden" name="nombre_producto" value="Flar Jegs jeans verde oscuro">
