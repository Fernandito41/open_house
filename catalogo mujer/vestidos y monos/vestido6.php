...
<body>
    ...
    <nav class="navbar"><!--Inicia la barra de navegacion con la clase para darle estilo-->
       ...
       <!-- ICONOS sacados de la libreria boopstrap -->
        ...
        <a href="../../ENLACES_HOOD&HIGH/carritodecompras.php"><!--Icono de carrito de compras-->
...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/vestido5.jpg" alt="Camisa boxy fit">
    <img src="../../img/vestido5.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Vestido Negro Corto</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Los monos negros de mujer se pueden describir con una sola palabra: "versátiles".
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Vestido Negro Corto">
    ...
    <div class="sizes">
        <label><input type="radio" name="talla" value="XS" required> XS</label>
        ...
        <label><input type="radio" name="talla" value="XXL"> XXL</label>
    </div>
  ...
  <div class="footer-links">
    <a href="../../ENLACES_HOOD&HIGH/enlace_sobre nostros.html">Sobre Hood&high</a><!--Enlaces que redirigen en el pie de pagina-->
