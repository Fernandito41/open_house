...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalon2.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalon2.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans recto blue</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Azul profundo con actitud contenida, este jeans tiene una vibra sobria pero firme.  
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans recto blue">
