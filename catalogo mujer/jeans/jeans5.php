...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalon6.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalon6.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans acampanado pale blue</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Gris medio con aire relajado le da a este jeans acampanado una vibra tranquila. 
    </p>
 ...
 <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Jeans acampanado pale blue">
