...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalon3.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalon3.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans recto cargo light blue</h2>
    <p class="price">$30.00</p>
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        <b>COLOR:</b>CELESTE<br>
        ...
        <b>DESCRIPCION:Celeste vibrante con energia visual, destaca por su tono electrico. 
    </p>
  ...
  <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Jeans recto cargo light blue">
