...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalon5.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalon5.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans baggy light gray</h2>
    <p class="price">$40.00</p>
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        <b>COLOR:</b>NEGRO<br>
        ...
        <b>DESCRIPCION:Negro tecnico con estructura, este modelo de jeans baggy con detalles mas marcados para quienes buscan funcionalidad con caracter. 
    </p>
  <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Jeans baggy light gray">
    ...
    <label for="talla"><b>Elige tu talla:</b></label>
      <div class="sizes">
            <label><input type="radio" name="talla" value="XS" form="add-to-cart" required> 20/28</label>
            <label><input type="radio" name="talla" value="S" form="add-to-cart"> 30/32</label>
            <label><input type="radio" name="talla" value="M" form="add-to-cart"> 32/34</label>
            <label><input type="radio" name="talla" value="L" form="add-to-cart"> 34/36</label>
            <label><input type="radio" name="talla" value="XL" form="add-to-cart"> 36/38</label>
            <label><input type="radio" name="talla" value="XXL" form="add-to-cart"> 38/40</label>
        </div>
