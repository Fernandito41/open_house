...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalon1.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalon1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans recto cargo gray</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Gris oscuro con estructura, el tono oxford le da a este cargo una vibra tranquila pero estilizada. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans recto cargo gray">
