...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones7.jpg">
    <img src="../../img/pantalones7.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Blanco Acampanado</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Un pantalón de color blanco con corte recto.
 ...
 <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Blanco Acampanado">
    <input type="hidden" name="precio" value="36.99">
