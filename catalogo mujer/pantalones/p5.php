...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones4.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalones4.jpg">
    </div>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:  Un pantalón de color negro bastante cómodo para salidas casuales.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Negro">
