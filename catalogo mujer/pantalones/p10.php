...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones11.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalones11.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Cafe Claro</h2>
    <p class="price">$39.99</p>
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        <b>COLOR:</b>CAFE CLARO<br>
        ...
        <b>DESCRIPCION:  Un pantalón de color café claro con un toque de elegancia.
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Cafe Claro">
