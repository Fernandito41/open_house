...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones1.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalones1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Gris Recto</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Un pantalón de color gris con un corte recto.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Gris Recto">
