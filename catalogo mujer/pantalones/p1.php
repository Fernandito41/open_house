...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones6.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalones6.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Gris Acampanado</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:  Un pantalón de color gris con un corte acampanado.
    </p>
  ...
  <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Gris Acampanado">
