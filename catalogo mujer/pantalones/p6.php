...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones5.jpg" alt="Camisa boxy fit">
    <img src="../../img/pantalones5.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Blanco</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Un pantalón de color blanco estupendo para salidas.
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Blanco">
