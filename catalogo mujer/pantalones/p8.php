...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/pantalones9.jpg">
    <img src="../../img/pantalones9.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon Negro Baggy</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION: Un pantalón de color negro bastante cómo e ideal para salidas.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon Negro Baggy">
