...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy16.jpg
" alt="Camisa trapstar">
    <img src="../../img/./catalogo de conjuntos/baggy16conjunto.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans gris claro</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Pantalon clasico con un twist moderno que se adapta a cualquier outfit urbano.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans gris claro">
