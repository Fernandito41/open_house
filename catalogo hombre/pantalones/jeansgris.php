...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy17.jpg" alt="Jeans Grey">
    <img src="../../img/./catalogo de conjuntos/baggy17conjunto.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans griss classic</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Pantalon gris con bolsillos funcionales y corte tapered para una estetica utilitaria con flow.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans griss classic">
