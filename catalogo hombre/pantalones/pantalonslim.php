...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy7.jpg" alt="Pantalon slim fit floral design">
    <img src="../../img/baggy7.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon slim fit floral design</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Este pantalon con estampado floral es un pieza que mezcla sensibilidad con rebeldia ideal para quienes rompen estereotipos con estilo.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon slim fit floral design">
