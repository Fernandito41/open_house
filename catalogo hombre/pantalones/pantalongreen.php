...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy6.jpg" alt="Pantalon baggy green">
    <img src="../../img/baggy6.jpg">
    ...
    <div class="right">
    <h2>Pantalon baggy green vintage</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Camuflaje urbano con actitud, este pantalon baggy tiene un diseño que mezcla lo tactico con lo estetico. 
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon baggy green vintage">
