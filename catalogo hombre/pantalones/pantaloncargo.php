...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy4.jpg" alt="Pantalon cargo camuflajeado">
    <img src="../../img/baggy4.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon cargo camuflajeado</h2>
    ...
    <p class="informacion"> <b>CORTE</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Funcionalidad con flow, este cargo baggy tiene bolsillos amplios y una estructura firme para los outfits con hoodies, gorras y sneakers robustos.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon cargo camuflajeado">
