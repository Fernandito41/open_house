...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy10.jpg" alt="Pantalon slim fit floral design">
    <img src="../../img/baggy10.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon baggy american style</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Denim clasico con alma rebelde, este pantalon negro tiene detalles como parches de rayos amarrillos.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon baggy american style">
