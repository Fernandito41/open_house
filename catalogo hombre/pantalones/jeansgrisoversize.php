...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy18.jpg" alt="Jeans Grey">
    <img src="../../img/./catalogo de conjuntos/baggy18conjunto.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans gris oversize</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Pantalon slim fit con un contraste lateral ideal para looks pulidos pero relajados.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans gris oversize">
