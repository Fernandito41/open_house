...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy.jpg" alt="Camisa trapstar">
    <img src="../../img/baggy.jpg" alt="">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon basic super baggy</h2>
    <p class="price">$49.99</p>
    <p class="color">GRIS</p>
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        <b>COLOR:</b> GRIS<br>
        ...
        <b>DESCRIPCION:El basico que nunca falla con un corte baggy y un tono gris medio ideal para looks neutros con actitud.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon basic super baggy">
