...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy3.jpg" alt="Camisa boxy fit">
    <img src="../../img/baggy3.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon basic super baggy desgastado</h2>
    ...
    <p class="informacion"> <b>CORTE</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Pantalon azul claro tiene un efecto desgastado que lo hace destacar con una nostalgia noventera.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon basic super baggy desgastado">
