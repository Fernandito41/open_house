...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy15.jpg
" alt="Camisa trapstar">
    <img src="../../img/./catalogo de conjuntos/baggy15conjunto.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Pantalon baggy con fit relajado para el urbanismo con toque sartorial.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Fiery jean">
