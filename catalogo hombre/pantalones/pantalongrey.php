...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy13.jpg" alt="Jeans Grey">
    <img src="../../img/baggy13.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon baggy basic grey</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Minimalismo urbano, este pantalon baggy es una base perfecta para cualquier outfit.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon baggy basic grey">
