...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy2.jpg" alt="Camisa trapstar">
    <img src="../../img/baggy2.jpg" alt="">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon supper baggy vintage bordado</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> BAGGY<br>
        ...
        <b>DESCRIPCION:Arte en movimiento con un estampado para quienes ven la moda como expresion.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon supper baggy vintage bordado">
