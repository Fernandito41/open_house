...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy19.jpg" alt="Jeans Grey">
    <img src="../../img/./catalogo de conjuntos/baggy19conjunto.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Jeans negro oversize</h2>
    ...
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Pantalon con corte recto y estructura firme para quienes se expresan sin etiquetas.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jeans negro oversize">
