...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy5.jpg" alt="Pantalon cargo camuflajeado">
    <img src="../../img/baggy5.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon super baggy hip hop gothic</h2>
    ...
    <p class="informacion"> <b>CORTE</b>BAGGY<br>
        ...
        <b>DESCRIPCION:Pantalon azul oscuro con estampado galactico en la pierna izquierda es una pieza unica, estetica futurista y urbana.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon super baggy hip hop gothic">
    <input type="hidden" name="precio" value="45.99">
