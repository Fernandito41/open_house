...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/baggy14.jpg" alt="Pantalon slim fit floral design">
    <img src="../../img/baggy14.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Pantalon super baggy spider</h2>
    <p class="price">$49.99</p>
    <p class="color">Negro</p>
    <p class="informacion"> <b>CORTE:</b>BAGGY<br>
        <b>COLOR:</b>NEGRO<br>
        <b>MATERIALES:</b><br> mezcla de algodón y elastano, la tela de algodón es hipoalergénica, tiene alta capacidad de absorción, permite que la piel respire con regularidad. El elastano por su parte permite que la tela se estire para dar mayor libertad de movimiento.
        <b>DESCRIPCION:Negro total con energia tribal, este pantalon baggy tiene un estampado de llamas blancas en la pierna izquierda que le da un aire mistico y poderoso. 
      </p>

     <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    <input type="hidden" name="id_producto" value="12"> <!-- id_producto de tu tabla -->
    <input type="hidden" name="nombre_producto" value="Pantalon super baggy spider">
    <input type="hidden" name="precio" value="49.99">


    <!-- Selección de talla -->
    <label for="talla"><b>Elige tu talla:</b></label>
    <div class="sizes">
            <label><input type="radio" name="talla" value="30" form="add-to-cart" required> 30</label>
            <label><input type="radio" name="talla" value="34" form="add-to-cart"> 34</label>
            <label><input type="radio" name="talla" value="36" form="add-to-cart"> 36</label>
            <label><input type="radio" name="talla" value="38" form="add-to-cart"> 38</label>
            <label><input type="radio" name="talla" value="40" form="add-to-cart"> 40</label>
            <label><input type="radio" name="talla" value="42" form="add-to-cart"> 42</label>
            <label><input type="radio" name="talla" value="44" form="add-to-cart"> 44</label>
            <label><input type="radio" name="talla" value="46" form="add-to-cart"> 46</label>
            <label><input type="radio" name="talla" value="48" form="add-to-cart"> 48</label>
        </div>
