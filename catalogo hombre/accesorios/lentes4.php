...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios3.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios3.jpg">
    </div>
    ...
    <p class="color">METAL</p>
        ...
        <b>DESCRIPCION:Futuristas y funcionales, marco plateado con lentes azul espejo tienen una vibra sci-fi que no pasa desapercibida.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Lentes Oakley">
