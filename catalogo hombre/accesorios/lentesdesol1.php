...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Lentes de sol Deportivos Negro</h2>
    <p class="price">$15.00</p>
    <p class="color">NEGROS</p>
        <b>COLOR:</b> Negros<br>
        <b>MATERIALES:</b> Plastico<br>
        <b>DESCRIPCION:Deportivos con actitud, diseño envolvente en negro brillante perfectos para moverse con estilo.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Lentes de sol Deportivos Negros">
