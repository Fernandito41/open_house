...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios12.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios12.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Reloj Rolex Moderno</h2>
    <p class="price">$45.99</p>
    <p class="color">PLATEADO</p>
        <b>MATERIALES:</b> Metal<br>
        <b>DESCRIPCION:Plata pulida con ritmo consante, este reloj tiene una vibra limpia y directa.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Rolex Moderno">
