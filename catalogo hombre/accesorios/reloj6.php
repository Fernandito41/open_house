...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/relojdorado.jpg" alt="Blusa esfera">
    <img src="../../img/relojdorado.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Reloj Moderno Dorado</h2>
    <p class="price">$39.99</p>
    <p class="color">DORADO</p>
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Moderno Dorado">
