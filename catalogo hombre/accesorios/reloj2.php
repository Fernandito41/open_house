...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios8.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios8.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Reloj Casio Clasico</h2>
    <p class="price">$39.99</p>
    <p class="color">PLATEADO</p>
        <b>MATERIALES:</b> Metal<br>
        <b>DESCRIPCION:Clasico pero con presencia, este casio tiene el equilibrio perfecto entre tradicion y actitud.<br>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Casio Clasico">
