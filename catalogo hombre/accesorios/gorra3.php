...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios6.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios6.jpg">
    </div>
    ...
    <p class="color">NEGRO</p>
        ...
        <b>DESCRIPCION:Grafico urbano rostro en sombra, gorra que proyecta una energia potente para quienes entienden que el estilo tambien se comunica en siluetas. <br>
    ...
    <input type="hidden" name="nombre_producto" value="ADIDAS NSRC">
