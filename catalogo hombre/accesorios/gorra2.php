...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios5.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios5.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Gorra Cars rosa y blanco</h2>
    <p class="price">$20.00</p>
    <p class="color">ROSA Y BLANCA</p>
        <b>MATERIALES:</b> Algodon<br>
        <b>DESCRIPCION:Blanca y rosado moderna, con diseño de rostro estilizado que proyecta energia. <br>

    <label for="talla"><b>Elige tu talla:</b></label>
        <div class="sizes">
      <label><input type="radio" name="talla" value="UNICA" form="add-to-cart" required>UNICA</label>
        </div>
    ...
    <input type="hidden" name="nombre_producto" value="Gorra Cars rosa y blanco">
