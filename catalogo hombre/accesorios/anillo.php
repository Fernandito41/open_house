...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios14.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios14.jpg">
    </div>s
    ...
    <input type="hidden" name="nombre_producto" value="Anillo">
    <input type="hidden" name="precio" value="9.99">
...
<div class="footer-column"><!--Inicio del apartado de te puede interesar-->
  ...
  <div class="footer-links">
    ...
    <a href="../../ENLACES_HOOD&HIGH/hoddies.">Camisetas y hoodies</a>
