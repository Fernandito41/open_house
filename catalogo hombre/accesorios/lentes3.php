...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios2.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios2.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Lentes Color Metal</h2>
    <p class="price">$15.00</p>
    <p class="color">METAL</p>
        <b>MATERIALES:</b> Plastico<br>
        <b>DESCRIPCION:Metalicos y marcados, con estructura angular en negro metalico para quienes prefieren el detalleque corta el ruido visual.<br> 
    ...
    <input type="hidden" name="nombre_producto" value="Lentes Color Metal">
