...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios4.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios4.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Gorra de Beisbol</h2>
    <p class="price">$20.00</p>
    <p class="color">BLANCO CON AZUL</p>
        <b>MATERIALES:</b> Plastico<br>
        <b>DESCRIPCION:Blanca y azul con sabor vintage, esta gorra combina paneles en denim con un logo bordado al frente que impone presencia.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Gorra de Beisbol">
