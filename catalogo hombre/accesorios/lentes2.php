...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios1.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios1.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Lentes de sol Deportivos Blancas</h2>
    <p class="price">$15.00</p>
    <p class="color">BLANCAS</p>
        <b>MATERIALES:</b> Plastico<br>
        <b>DESCRIPCION:Matices en deporte, con marco gris semitransparente y lentes a juego tienen un aire moderno y funcional.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Lentes de sol Deportivos Blancas">
