...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios7.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios7.jpg">
    </div>
    ...
    <p class="color">PLATEADO</p>
        ...
        <b>DESCRIPCION:Elegancia con filo, este casio combina lienas limpias con una vibra clasica que no necesita presentacion. <br>
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Clasico">
