...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios10.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios10.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Reloj Rolex Clasico</h2>
    <p class="price">$50.00</p>
    <p class="color">PLATEADO</p>
        <b>MATERIALES:</b> Metal<br>
        <b>DESCRIPCION:Deportivo, directo, sin rodeos. Este reloj es puro movimiento.<br> 
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Rolex Clasico">
