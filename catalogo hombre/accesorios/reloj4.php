...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/accesorios11.jpg" alt="Blusa esfera">
    <img src="../../img/accesorios11.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Reloj Rolex Monday</h2>
    <p class="price">$69.99</p>
    <p class="color">PLATEADO</p>
        <b>MATERIALES:</b> Metal<br>
        <b>DESCRIPCION:Grande, preciso, dominante. Su diseño robusto y acabado pulido lo convierten en una pieza que habla de poder sin perder elegancia.<br>
    ...
    <input type="hidden" name="nombre_producto" value="Reloj Rolex Monday">
