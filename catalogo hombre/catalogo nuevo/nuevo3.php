...
<div class="container">
    <div class="left">
        <img src="../../img/new13.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new13.jpg">

    </div>

    <div class="right">
        <h2>Camiseta GREEN00</h2>
        <p class="price">$30.99</p>
        <p class="color">Beige y verde</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b> BEIGE Y VERDE<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Beige y verde con una tipografia frontal que le da caracter sin saturar. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camiseta GREEN00">
