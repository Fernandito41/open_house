...
<div class="container">
    <div class="left">
        <img src="../../img/new9.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new9.jpg">

    </div>

    <div class="right">
        <h2>Jean Straight Classic</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Azul lavado con texura visual, pantalon con corte suelto ideal para quienes viven en movimiento y necesitan estilo con con utilidad.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jean Straight Classic">
