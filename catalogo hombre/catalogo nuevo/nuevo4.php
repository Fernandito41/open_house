...
<div class="container">
    <div class="left">
        <img src="../../img/new14.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new14.jpg">

    </div>

    <div class="right">
        <h2>CAMISETA LOONEY07</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Azul con grafico y actitud directa con un diseño frontal de silvestre. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="CAMISETA LOONEY07">
