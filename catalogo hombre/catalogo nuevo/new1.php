...
<div class="container">
    <div class="left">
        <img src="../../img/new1.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new1.jpg">

    </div>

    <div class="right">
        <h2>Jean retro washed</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Azul ceñido pero rebelde, este pantalon con roturas fontales es puro caracter. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Jean retro washed">
