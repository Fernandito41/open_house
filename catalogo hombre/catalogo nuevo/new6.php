...
<div class="container">
    <div class="left">
        <img src="../../img/new5.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new5.jpg">

    </div>

    <div class="right">
        <h2>Camiseta VARSITY46</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Deportiva y con actitud, jersey tipo varsity en negro con el numero 46 al frente en blanco.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camiseta VARSITY46">
