...
<div class="container">
    <div class="left">
        <img src="../../img/new12.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new12.jpg">

    </div>

    <div class="right">
        <h2>Camisa retro Cristiano Ronaldo</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Camiseta blanca con una imagen de Cristiano Ronaldo en la parte principal.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa retro Cristiano Ronaldo">
