...
<div class="container">
    <div class="left">
        <img src="../../img/new4.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new4.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta Mercedes</h2>
        <p class="price">$50.00</p>
        <p class="color">BLANCO Y NEGRO</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b>BLANCO Y NEGRO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Denim claro sin freno, chaqueta con parches deportivos y bordados que cuentan historias. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta Mercedes">
