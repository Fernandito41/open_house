...
<div class="container">
    <div class="left">
        <img src="../../img/new2.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new2.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta Varsity</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Rayas sutiles pero iluminado, chaqueta cafe con lineas verticales que proyectan sobriedad con intencion. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta Varsity">
