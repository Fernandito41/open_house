...
<div class="container">
    <div class="left">
        <img src="../../img/new3.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new3.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta College NY</h2>
        <p class="price">$49.99</p>
        <p class="color">Azul y negro</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b>AZUL Y NEGRO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Oscuridad con heraldica, chaqueta azul marino con el logo de los Yankees al frente. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta College NY">
