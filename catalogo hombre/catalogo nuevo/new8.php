...
<div class="container">
    <div class="left">
        <img src="../../img/new7.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new7.jpg">

    </div>

    <div class="right">
        <h2>Camiseta FlAMING22</h2>
        <p class="price">$49.99</p>
        <p class="color">BLANCO Y CAFE</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b>BLANCO Y CAFE<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Multicolor con alegria visual, esta camiseta tiene energia, constraste y flow.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camiseta FlAMING22">
