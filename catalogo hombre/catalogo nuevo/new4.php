...
<div class="container">
    <div class="left">
        <img src="../../img/new-conjunto.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new-conjunto.jpg">

    </div>

    <div class="right">
        <h2>Camisetas NFL19</h2>
        <p class="price">$30.99</p>
        <p class="color">ROJO Y BLANCO</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b> ROJO Y BLANCO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Jersey tipo baseball jaspeado con mangas burdeos y numero 19 al reverso.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisetas NFL19">
