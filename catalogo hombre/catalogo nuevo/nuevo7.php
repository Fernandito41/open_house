...
<div class="container">
    <div class="left">
        <img src="../../img/new17.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new17.jpg">

    </div>

    <div class="right">
        <h2>JEANS BAGGY PARCHE</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Jeans oscuros con caida relajada que fluye con naturalidad.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="JEANS BAGGY PARCHE">
