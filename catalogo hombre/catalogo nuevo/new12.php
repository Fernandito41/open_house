...
<div class="container">
    <div class="left">
        <img src="../../img/new11.jpg" alt="Pañoleta red">
    ...
    <div class="right">
        ...
        <p class="informacion">
            <b>COLOR:</b>ROJO<br>
            <b>MATERIALES:</b>TELA<br>
            <b>DESCRIPCION:Rojo clasico, resistencia visual. El pañuelo rojo con patron paisley es un icono no necesita presentacion. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pañoleta red">
