...
<div class="container">
    <div class="left">
        <img src="../../img/new16.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new16.jpg">

    </div>

    <div class="right">
        <h2>CAMISETA BRAND</h2>
        <p class="price">$49.99</p>
        <p class="color"> CAFE Y BLANCO</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b> CAFE Y BLANCO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:La segunda Oberon Brand mantiene el mismo diseño, ideal para quienes buscan consistencia visual en su coleccion. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="CAMISETA BRAND">
