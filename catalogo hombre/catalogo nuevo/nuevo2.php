...
<div class="container">
    <div class="left">
        <img src="../../img/new20.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new20.jpg">
    ...
    <div class="right">
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Blanco total con estructura limpia, este hoodie tiene un diseño sobrio y firme.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoodie nike">
