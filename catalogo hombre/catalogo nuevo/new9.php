...
<div class="container">
    <div class="left">
        <img src="../../img/new8.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new8.jpg">

    </div>

    <div class="right">
        <h2>Pantalon cargo TAN</h2>
        <p class="price">$30.99</p>
        <p class="color">CAFE</p>
        <p class="informacion">
            <b>CORTE:</b> RECTO<br>
            <b>COLOR:</b> CAFE<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Cafe claro funcional y relajado, pantalon cargo con bolsillos amplios y corte suelto.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Pantalon cargo TAN">
