...
<div class="container">
    <div class="left">
        <img src="../../img/new6.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new6.jpg">

    </div>

    <div class="right">
        <h2>Camiseta HERITAGE97</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Jersey jaspeado vintage y acogedora, con el numero 97 en tipografia desgastada.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camiseta HERITAGE97">
