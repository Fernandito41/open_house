...
<div class="container">
    <div class="left">
        <img src="../../img/new10.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new10.jpg">

    </div>

    <div class="right">
        <h2>Durag Black Flow</h2>
        <p class="price">$40.00</p>
        <p class="color">NEGRO</p>
        <p class="informacion">
            <b>COLOR:</b>NEGRO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Negro mate con caida relajada, este durag tine un diseño suelto que rompe con la esructura clasica. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Durag Black Flow">
