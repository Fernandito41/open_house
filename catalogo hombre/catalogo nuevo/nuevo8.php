...
<div class="container">
    <div class="left">
        <img src="../../img/new18.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new18.jpg">

    </div>

    <div class="right">
        <h2>PANTALON BAGGY PRINT</h2>
        <p class="price">$49.99</p>
        <p class="color">CAFE CLARO</p>
        <p class="informacion">
            <b>CORTE:</b> BAGGY<br>
            <b>COLOR:</b>CAFE CLARO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Caida relajada con actitud visual, pantalon baggy una pieza que respira calle, comodidad y presencia.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="PANTALON BAGGY PRINT">
