...
<div class="container">
    <div class="left">
        <img src="../../img/new19.jpg" alt="Camisa corte oversize another">
        <img src="../../img/new19.jpg">

    </div>

    <div class="right">
        <h2>SHORT FULL WHITE</h2>
        <p class="price">$40.99</p>
        <p class="color">CELESTE Y BLANCO</p>
        <p class="informacion">
            <b>CORTE:</b> RECTO<br>
            <b>COLOR:</b> CELESTE Y BLANCO<br>
            <b>MATERIALES:</b> mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:Short denim celeste con blanco con corte relajado para quienes prefieren destacar desde la simplicidad. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="SHORT FULL WHITE">
