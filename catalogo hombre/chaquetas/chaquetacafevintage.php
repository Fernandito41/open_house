...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta3.jpg" alt="Chaqueta cafe oscuro">
        <img src="../../img/chaqueta3.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta cafe vintage</h2>
        <p class="price">$39.99</p>
        <p class="color">CAFE VINTAGE</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b> CAFE VINTAGE<br>
            <b>MATERIALES:</b><br> mezcla de algodón y elastano...
            <b>DESCRIPCION:Oscura, directa, sin disculpas, esta chaqueta cafe es puo caracter minimalista, firme y con una vibra misteriosa.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta cafe vintage">
