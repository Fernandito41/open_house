...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta8.jpg" alt="Camisa 2pac">
        <img src="../../img/chaqueta8.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta carrera M&M's Black</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Deportivo pero con calle, esta chaqueta mezcla vibra atletica con estetica vintage. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta carrera M&M's Black">
