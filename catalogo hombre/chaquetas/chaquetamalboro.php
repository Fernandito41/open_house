...
<div class="container">
    <div class="left">
        <img src="../../img/chaquetax1.jpg" alt="">
        <img src="../../img/chaquetax1.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta cuero malboro</h2>
        <p class="price">$39.99</p>
        <p class="color">Blanco y rojo</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b> BLANCO Y ROJO<br>
            <b>MATERIALES:</b><br> mezcla de algodón y elastano...
            <b>DESCRIPCION:Volumen con proposito, roja como tu actitud esta puffer no pasa desapercibida.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta cuero malboro">
