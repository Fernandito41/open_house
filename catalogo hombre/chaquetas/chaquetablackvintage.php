...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta5.jpg" alt="Chaqueta black vintage">
        <img src="../../img/chaqueta5.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta black vintage</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Minimalismo con presencia, una chaqueta que no grita pero impone. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta black vintage">
