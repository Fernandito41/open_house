...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta9.jpg" alt="Chaqueta carrera M&M's Black">
        <img src="../../img/chaqueta9.jpg">

    </div>g

    <div class="right">
        <h2>Chaqueta carrera M&M's White</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Blanca, atrevida y cargada de energia visual, esta chaqueta tipo racing en blanco es puro dinamismo. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta carrera M&M's White">
