...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta10.jpg" alt="Chaqueta malboro black">
        <img src="../../img/chaqueta10.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta malboro black</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Negra, directa y con actitud basica, con el logo de malboro en blanco y el grafico del cowboy tiene una vibra notalgica y fuerte. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta malboro black">
