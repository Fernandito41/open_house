...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta.jpg" alt="Camisa 2pac">
        <img src="../../img/chaqueta.jpg">

    </div>

    <div class="right">
        <h2>Carhartt chaqueta</h2>
        <p class="price">$40.99</p>
        <p class="color">NEGRO CON BLANCO</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b> NEGRO CON BLANCO<br>
            <b>MATERIALES:</b>mezcla de algodón y elastano...<br>
            <b>DESCRIPCION:La clasica nunca falla, esta bomber negro profundo con blanco es puro equilibrio entre elegancia y rebeldia.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Carhartt chaqueta">
