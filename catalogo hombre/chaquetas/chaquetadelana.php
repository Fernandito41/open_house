...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta7.jpg" alt="Camisa 2pac">
        <img src="../../img/chaqueta7.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta de lana</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Funcionalidad con actitud, esta chaqueta con cierre frontal es tu aliada para dias impredecibles. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta de lana">
