...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta4.jpg" alt="Chaqueta vintage carhartt">
        <img src="../../img/chaqueta4.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta vintage carhartt</h2>
        <p class="price">$40.00</p>
        <p class="color">Verde musgo</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b> VERDE MUSGO<br>
            <b>MATERIALES:</b><br> mezcla de algodón y elastano...
            <b>DESCRIPCION:Comodidad con caracter, esta cahqueta en verde musgo tiene el volumen justo para destacar sin esfuerzo. 
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta vintage carhartt">
