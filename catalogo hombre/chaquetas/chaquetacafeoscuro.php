...
<div class="container">
    <div class="left">
        <img src="../../img/chaquetas2.jpg" alt="Camisa 2pac">
        <img src="../../img/chaquetas2.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta cafe oscuro</h2>
        <p class="price">$39.99</p>
        <p class="color">CAFE OSCURO</p>
        <p class="informacion">
            <b>MANGA:</b> LARGA<br>
            <b>COLOR:</b> CAFE OSCURO<br>
            ...
            <b>DESCRIPCION:Ligera pero letal, diseñada para moverse contigo esta windbreaker cafe es discreta pero poderosa.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta cafe oscuro">
