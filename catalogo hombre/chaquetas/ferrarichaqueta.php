...
<div class="container">
    <div class="left">
        <img src="../../img/chaqueta1.jpg" alt="">
        <img src="../../img/chaqueta1.jpg">

    </div>

    <div class="right">
        <h2>Chaqueta ferrari</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:El alma del barrio en cada costura, con textura vivida y detalles que cuentan historias.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Chaqueta ferrari">
