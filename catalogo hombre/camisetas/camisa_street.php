...
<div class="container">
    <div class="left">
        <img src="../../img/ov2.jpg" alt="Camisa street life">
        <img src="../../img/ov2.jpg">

    </div>

    <div class="right">
        <h2>Camiseta street life</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Prenda de una fusion entre arte urbano y moda casual hecha para los que buscan expresion y movimiento en cada outfit.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camiseta street life">
