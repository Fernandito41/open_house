...
<div class="container">
    <div class="left">
        <img src="../../img/camisa14.jpg" alt="Camisa 2pac">
        <img src="../../img/camisa14.jpg">

    </div>

    <div class="right">
        <h2>Camisa OFF WHITE</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Prenda inspirada en el iconico estilo urbano de las grandes marcas.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa OFF WHITE">
