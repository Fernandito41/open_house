/*Quitar margenes por defecto*/<?php
session_start();
?>
<!DOCTYPE html>
<html lang="es">
...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/imagenov8.jpg" alt="Camisa casual blanca">
    <img src="../../img/imagenov8.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa TRUSHER GRAY</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Prenda con un corte oversize con una estetica callejera para quienes dominan la ciudad sin levantar la voz.
      </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Camisa TRUSHER GRAY">
