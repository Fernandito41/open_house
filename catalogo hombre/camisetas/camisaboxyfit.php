...
<body>
    ...
    <nav class="navbar"><!--Inicia la barra de navegacion con la clase para darle estilo-->
       ...
       <div class="search-container"><!--Contenedor de barra de busqueda-->
        ...
        <!--aca termina la barra de busqueda-->
...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
        <img src="../../img/boxi.jpg" alt="Camisa boxy fit">
        <img src="../../img/catalogocamisa1.png.jpeg">
    </div>

    <!-- Información del producto -->
    <div class="right">
        <h2>Camisa boxy fit racodeloir hood&high</h2>
        ...
        <p class="informacion">
            ...
            <b>COLOR:</b> NEGRO<br>
            <b>MATERIALES:</b><br>
            mezcla de algodón y elastano, la tela de algodón es hipoalergénica, tiene alta capacidad de absorción, permite que la piel respire con regularidad. El elastano por su parte permite que la tela se estire para dar mayor libertad de movimiento.<br>
            <b>DESCRIPCION:</b> Una prenda con corte boxy fit y estilo urbano minimalista con un toque de streetwear.
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa boxy fit racodeloir hood&high">
