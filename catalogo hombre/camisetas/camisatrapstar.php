...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/ov6.jpg" alt="Camisa trapstar">
    <img src="../../img/ov6.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Esta prenda trapstar representa la energia del trap y la cultura de la calle.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa trapstar">
