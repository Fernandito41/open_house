...
<div class="container">
    <div class="left">
        <img src="../../img/camisa27.jpg" alt="Camisa corte oversize another">
        <img src="../../img/camisa27.jpg">

    </div>

    <div class="right">
        <h2>Camisa corte oversize another</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Esta camisa tiene un estampado llamativo en blanco y transmite energia y actitud.
          </p>
        
       <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    <input type="hidden" name="id_producto" value="13"> <!-- id_producto de tu tabla -->
    <input type="hidden" name="nombre_producto" value="Camisa corte oversize another">
