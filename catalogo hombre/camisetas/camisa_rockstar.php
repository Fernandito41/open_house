...
<div class="container">
    <div class="left">
        <img src="../../img/ov4.jpg" alt="Camisa rockstar">
        <img src="../../img/ov4.jpg">

    </div>

    <div class="right">
        <h2>Camisa manga corta ROCKSTAR</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Prenda inspirada en la actitud rebelde del rock que combina con un estampado audaz con un fondo oscuro.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa manga corta ROCKSTAR">
