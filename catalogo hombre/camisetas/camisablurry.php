...
<div class="container">
    <div class="left">
        <img src="../../img/ov3.jpg" alt="Camisa rockstar">
        <img src="../../img/ov3.jpg">

    </div>

    <div class="right">
        <h2>Camisa oversize BLURRY</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Prenda con un estilo misterioso y moderno que combina una estetica artistica con un corte oversize.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize BLURRY">
