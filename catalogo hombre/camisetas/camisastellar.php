...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/camisa20.jpg.." alt="Camisa manga corta stellar">
    <img src="../../img/camisa20.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa STELLAR</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Prenda con un diseño sutil y moderno perfecta para noches urbanas o dias relajados con flow.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa STELLAR">
