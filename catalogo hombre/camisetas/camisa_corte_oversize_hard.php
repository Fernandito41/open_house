...
<div class="container">
    <div class="left">
        <img src="../../img/camisa25.jpg" alt="Camisa 2pac">
         <img src="../../img/camisa25.jpg">

    </div>

    <div class="right">
        <h2>Camisa corte oversize hard</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Una prenda moderna que proyecta confianza y frescura. Su frase "hard not to look" da una vibra audaz y urbana.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa corte oversize hard">
