...
<div class="container">
    <div class="left">
        <img src="../../img/camisa10.jpg" alt="Camisa bottega">
        <img src="../../img/camisa10.jpg">

    </div>

    <div class="right">
        <h2>Camisa oversize BOTTEGA WHITE</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Estilo premium y street en una sola prenda, tiene una mezcla clasica con detalles modernos.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa oversize BOTTEGA WHITE">
