...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/camisaov9.jpg" alt="Camisa casual blanca">
    <img src="../../img/camisaov9.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa TRUSHER WHITE</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Prenda con el mismo grafico potente que su version gris y para quienes no temen destacar en la multitud.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa TRUSHER WHITE">
