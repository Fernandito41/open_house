...
<div class="container">
    <div class="left">
        <img src="../../img/camisa12.jpg" alt="Camisa Essentials">
        <img src="../../img/camisa12.jpg">

    </div>

    <div class="right">
        <h2>Camisa ESSENTIALS</h2>
        ...
        <p class="informacion">
            ...
            <b>DESCRIPCION:Camisa con estilo minimalismo y es una pieza versatil que combina con todo.
          </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa ESSENTIALS">
