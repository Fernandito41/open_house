...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/camisa26.jpg" alt="Camisa corte oversize bordado">
    <img src="../../img/camisa26.jpg">


    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa corte oversize bordado</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Esta camisa tiene una tipografia bordada atras y combina comodidad y detalle artesanal.
      </p>
        <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    <input type="hidden" name="id_producto" value="14"> <!-- id_producto de tu tabla -->
    <input type="hidden" name="nombre_producto" value="Camisa corte oversize bordado">
    <input type="hidden" name="precio" value="25.99">
