...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/ov5.jpg" alt="Camisa casual blanca">
    <img src="../../img/ov5.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Menos es mas, la basic black es una pieza esencial del armario urbano.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa basic black">
