...
<div class="container">
    <div class="left">
        <img src="../../img/overzide.jpg" alt="Camisa 2pac">
        <img src="../../img/overzide.jpg">
    </div>

    <div class="right">
        <h2>Camisa manga corta 2pac</h2>
        <p class="price">$55.00</p>
        <p class="color">Negro</p>
        <p class="informacion">
            <b>MANGA:</b> CORTA<br>
            <b>COLOR:</b> NEGRO<br>
            <b>MATERIALES:</b><br> de algodón y elastano, la tela de algodón es hipoalergénica, tiene alta capacidad de absorción, permite que la piel respire con regularidad. El elastano por su parte permite que la tela se estire para dar mayor libertad de movimiento.
            <b>DESCRIPCION:Prenda que rinde homenaje a una leyenda del rap.</b>
        </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa manga corta 2pac">
