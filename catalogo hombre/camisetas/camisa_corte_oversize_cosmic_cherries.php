...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/camisa21.jpg" alt="Camisa corte oversize cosmic cherries">
    <img src="../../img/camisa21.jpg">


    <!-- Información del producto -->
    <div class="right">
    <h2>Camisa corte oversize cosmic cherries</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> CORTA<br>
        ...
        <b>DESCRIPCION:Esta camisa tiene un diseño retro destacando las cerezas en el estampado trasero.
      </p>
    ...
    <input type="hidden" name="nombre_producto" value="Camisa corte oversize cosmic cherries">
