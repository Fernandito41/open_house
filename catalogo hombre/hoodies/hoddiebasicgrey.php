...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie7.jpg" alt="Hoodie Basic Black">
    <img src="../../img/hoddie7.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Hoddie basic gray</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Gris medio flow relajado, con un tono neutro y textura suave perfecto para llevarlo solo. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie basic gray">
