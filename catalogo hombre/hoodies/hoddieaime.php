...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie2.jpg" alt="Blusa de lino">
    <img src="../../img/hoddie2.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Gris con energia visual, con un print tipo grafiti en blanco que da la vibra callejera. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Hoodiea Aime">
