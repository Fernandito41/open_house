...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie4.jpg" alt="">
    <img src="../../img/hoddie4.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Sweatshirt gray</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Gris claro vibra relajada, sudadera perfecta para dias tranquilos con estilo. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Sweatshirt gray">
