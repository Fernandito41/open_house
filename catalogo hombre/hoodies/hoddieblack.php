...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie3.jpg" alt="Blusa de lino">
    <img src="../../img/hoddie3.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Negro total sin distracciones, minimalista y contundente, hoodie solido para quienes prefieren el silencio visual pero no pasan desapercibidos. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoodie Black">
