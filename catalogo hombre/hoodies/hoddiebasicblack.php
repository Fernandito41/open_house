...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie6.jpg" alt="Hoodie Basic Black">
    <img src="../../img/hoddie6.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Hoddie basic black</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Negro total, actitud intacta, este hoodie negro es la base de cualquier outfit callejero. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie basic black">
