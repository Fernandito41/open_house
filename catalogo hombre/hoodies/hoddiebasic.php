...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie.png" alt="Hoodie Basic">
    <img src="../../img/hoddie.png">
    </div>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Negro oscuro con actitud firme, este hoodie tiene ese tono battle-ready que encaja perfecto con el ritmo de la calle. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoodie basic">
