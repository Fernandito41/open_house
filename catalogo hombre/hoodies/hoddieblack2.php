...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie8.jpg" alt="Hoodie Basic Black">
    <img src="../../img/hoddie8.jpg">
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        <b>COLOR:</b>Negro<br>
        <b>MATERIALES:</b> mezcla de algodón y elastano, la tela de algodón es hipoalergénica, tiene alta capacidad de absorción, permite que la piel respire con regularidad. El elastano por su parte permite que la tela se estire para dar mayor libertad de movimiento.
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie Black">
