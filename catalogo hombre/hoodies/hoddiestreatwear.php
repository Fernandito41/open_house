...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie10.jpg" alt="Hoodie Basic Black">
    <img src="../../img/hoddie10.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Hoddie Streatwear</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Azul profundo con identidad, este hoodie navy lleva el logo de los Yankees al frente mezclando el deporte con la cultura urbana. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie Streatwear">
