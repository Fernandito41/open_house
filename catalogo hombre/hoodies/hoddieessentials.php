...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddies5.jpg" alt="Hoodie Essentials">
    <img src="../../img/hoddies5.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Hoddie Essemtials</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Gris medio con un equilibrio visual, hoodie que se mueve entre lo neutro y lo funcional para mantener mas flow sin esfuerzo. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie Essemtials">
