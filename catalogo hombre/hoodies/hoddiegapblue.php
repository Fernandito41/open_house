...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/hoddie11.jpg" alt="Hoodie Gap Blue">
    <img src="../../img/hoddie11.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Hoddie Gap Blue</h2>
    ...
    <p class="informacion"> <b>MANGA:</b> LARGA<br>
        ...
        <b>DESCRIPCION:Azul vibrante presencia directa. este hoodie azul royal destaca sin esfuerzo para quienes no temen mostrar color en medio del concreto. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Hoddie Gap Blue">
    <input type="hidden" name="precio" value="40.99">
