...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas8.jpg" alt="Short de Mezclilla">
    <img src="../../img/bermudas8.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short Basic super baggy</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> BAGGY<br>
        ...
        <b>DESCRIPCION:Negro con una vibra firme, este short es ideal para quienes buscan una base solida para su outfit urbano. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Short Basic super baggy">
