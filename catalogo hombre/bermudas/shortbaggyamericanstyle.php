...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas9.jpg" alt="Short de Mezclilla">
    ...
    <div class="right">
    <h2>Short Baggy American Style</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> BAGGY<br>
        ...
        <b>DESCRIPCION:Camuflaje azul con energia visual, este short lleva el patron clasico a un nuevo tono. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Baggy American Style">
