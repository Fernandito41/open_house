...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas3.jpg" alt="Blusa esfera">
    <img src="../../img/bermudas3.jpg">
    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Stussy 8ball Jorts</h2>
    <p class="price">$49.99</p>
    <p class="color">Celesye</p>
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Denim clasico sin complicaciones, este short de mezclilla azul medio tiene ese corte relajado que funciona en cualquier esquina. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Stussy 8ball Jorts">
