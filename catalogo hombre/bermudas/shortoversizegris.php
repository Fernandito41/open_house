...
<img src="../../img/bermudas12.jpg" alt="">
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Gris, sombra y luz denim, este short tiene un acabado lavado que juega con los contrastes. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Short Oversize Gris">
