...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas4.jpg" alt="Blusa esfera">
    <img src="../../img/bermudas4.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short Mcdonalds</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Denim fresco con vibra ligera, este short es para dias de sol y tardes de skate. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Mcdonalds">
    <input type="hidden" name="precio" value="30.99">
    <!-- Selección de talla -->
