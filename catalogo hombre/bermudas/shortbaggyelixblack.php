...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas7.jpg" alt="Short de Mezclilla">
    <img src="../../img/bermudas7.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short Baggy Elix BLack</h2>
    <p class="price">$55.00</p>
    <p class="color">Negro</p>
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        <b>COLOR:</b> Negro<br>
        <b>MATERIALES:</b><b> mezcla de algodón y elastano, la tela de algodón es hipoalergénica, tiene alta capacidad de absorción, permite que la piel respire con regularidad. El elastano por su parte permite que la tela se estire para dar mayor libertad de movimiento.
        <b>DESCRIPCION:Camufaje negro presencia tactica, este short mezcla lo urbano con el patron de los tonos oscuros. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Baggy Elix BLack">
