...
<img src="../../img/bermudas11.jpg" alt="">
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Denim medio con nostalgia fuerte, este short oversize lleva impreso el año 1979 evocando una vibra retro potente. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Short Jeans Oversize">
