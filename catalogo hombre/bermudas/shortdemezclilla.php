...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas5.jpg" alt="Short de Mezclilla">
    <img src="../../img/bermudas5.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short de Mezclilla</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Denim profundo estilo sobrio, con un tono mas serio y estructura firme para quienes prefieren el contraste entre lo clasico y moderno. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short de Mezclilla">
