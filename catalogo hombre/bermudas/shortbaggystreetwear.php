...
<img src="../../img/short_streetwear.jpg" alt="">
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Negro con detalles electricos, este short baggy en negro lleva un tipo rayo blanco que le da una actitud callejera. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Baggy streatwear">
