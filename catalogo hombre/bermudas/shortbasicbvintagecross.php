...
<img src="../../img/bermudas10.jpg" alt="">
    ...
    <div class="right">
    <h2>Short Basic vintage cross</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Azul medio con identidad, con un tono neutro perfecto para un flow relajado. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Basic vintage cross">
