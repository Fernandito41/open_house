...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas1.jpg" alt="Blusa esfera">
    <img src="../../img/bermudas1.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short Lunnete BLack</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Negro profundo con energia visual con un fit ceñido y un tono vibrante. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Lunnete BLack">
