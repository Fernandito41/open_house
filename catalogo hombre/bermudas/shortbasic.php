...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas.jpg" alt="Blusa esfera">
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Negro total actitud firme, este short negro es puro enfoque. 
    </p>
    ...
    <input type="hidden" name="nombre_producto" value="Short Basic">
