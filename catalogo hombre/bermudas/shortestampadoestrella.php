...
<div class="container">
    <!-- Imagen del producto -->
    <div class="left">
    <img src="../../img/bermudas6.jpg" alt="Short de Mezclilla">
    <img src="../../img/bermudas6.jpg">

    </div>

    <!-- Información del producto -->
    <div class="right">
    <h2>Short Estampado Estrella</h2>
    ...
    <p class="informacion"> <b>CORTE:</b> RECTO<br>
        ...
        <b>DESCRIPCION:Negro con textura y una actitud sin pausa, este short tiene un diseño sobrio pero con caracter. 
    </p>
   ...
   <form id="add-to-cart" action="../../carrito/agregar_carrito.php" method="POST">
    ...
    <input type="hidden" name="nombre_producto" value="Short Estampado Estrella">
